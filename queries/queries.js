...
const addActuality = "INSERT INTO actuality (title, description, link, image) VALUES ($1, $2, $3, $4)"
...
const UpdateActuality = "UPDATE actuality SET title = $1 , description = $2, link = $3, image = $4 WHERE id = $5"
const UpdateActualityWithoutImage = "UPDATE actuality SET title = $1 , description = $2, link = $3 WHERE id = $4"
