...
const addActuality = "INSERT INTO actuality (title, description, link, image, slug) VALUES ($1, $2, $3, $4, $5)";
...
const UpdateActuality = "UPDATE actuality SET title = $1 , description = $2, link = $3, image = $4, slug = $5 WHERE id = $6"
...
const addActualityContent = "INSERT INTO actuality_content (actuality_id, content) VALUES ($1, $2)";
